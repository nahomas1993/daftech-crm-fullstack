...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'clients/import-attachments',
        canActivate: [adminRoleGuard],
        loadComponent: () => import('./staff/clients/client-import-attachments.component').then(m => m.ClientImportAttachmentsComponent),
      },
      {
        path: 'clients/:id',
        canActivate: [adminRoleGuard],
      ...
      { path: 'tickets', loadComponent: () => import('./staff/tickets/tickets.component').then(m => m.TicketsComponent) },
      {
        ...
        loadComponent: () => import('./staff/my-trainings/my-trainings.component').then(m => m.MyTrainingsComponent),
      },
      {
        path: 'employees',
        canActivate: [adminRoleGuard],
