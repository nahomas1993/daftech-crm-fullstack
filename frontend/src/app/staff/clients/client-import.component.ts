  ...
  template: `
    ...
    <div class="panel panel-pad" style="max-width: 760px;">
      ...
      <ul class="text-muted" style="font-size:0.82rem; line-height:1.6; margin: 0.5rem 0 0.9rem 1.1rem;">
        ...
        <li>Each row can also log up to 5 historical training sessions using the repeated <span class="mono">Training1Name</span>…<span class="mono">Training5Name</span> column groups. <span class="mono">TrainingXName</span> must exactly match a Training Item configured under Settings, and <span class="mono">TrainingXDate</span>/<span class="mono">TrainingXDescription</span> are required whenever a slot's Name is filled in — but <span class="mono">TrainingXTrainerName</span> is optional, since these sessions already happened and the paper record often doesn't say who conducted them. Leave a slot's Name blank to skip it entirely.</li>
